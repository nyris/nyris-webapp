    ...
    <>
      ...
      <div className="wrap-main-item-result max-w-[190px] w-[180px] desktop:w-[190px] border border-solid border-[#E0E0E0] scroll-pt-5">
        <div className="relative h-fit">
          ...
          {settings.cadenas?.cadenas3dWebView && !settings.machineSearch && (
            <div
          ...
          {settings.machineSearch && (
            <div
              ...
              style={{
                backgroundColor:
                  dataItem.sku === reverseSelectedProduct?.sku
                    ? '#E4E3FF'
                    : '#E9E9EC',
              }}
              onClick={() => {
                if (dataItem.sku === reverseSelectedProduct?.sku) {
                  setReverseSelectedProduct(undefined);
                } else {
                  setReverseSelectedProduct(dataItem);
                }
              }}
            >
              <Icon
                ...
                height={20}
                color={
                  reverseSelectedProduct?.sku === dataItem.sku
                    ? '#3E36DC'
                    : '#2B2C46'
                }
              />
