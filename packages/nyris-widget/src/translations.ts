const translations = (language: string) => {
    ...
    return {
        ...
        'Hold on': 'Hold on',
        'We are working hard on finding the product': 'We are working hard on finding the product',
        'Success!': 'Success!',
        'matches found': 'matches found',
        'View more': 'View more',
        'Something went wrong': 'Something went wrong',
        'Oops!': 'Oops! We encountered an issue during the search. Please ensure your image meets the guidelines and try again',
