const translations = (language: string) => {
  if (language === 'de') {
    return {
      Search: 'Suche',
      ...
      'We couldn’t find matches':
        'Diesmal konnten wir keine Übereinstimmungen finden. Um die besten Ergebnisse zu erzielen, verwenden Sie bitte ein scharfes, gut beleuchtetes und zentriertes Foto mit einem ruhigen Hintergrund und versuchen Sie es noch einmal!',
